...
class PurePursuit(Node):
    ...
    def pose_callback(self, odometry_msg):
        self.relative_x = odometry_msg.pose.pose.position.x
        self.relative_y = odometry_msg.pose.pose.position.y - 0.02
        ...
        steering_angle = math.atan2(2.0 * self.wheelbase_length * math.sin(angle_to_line), distance)
